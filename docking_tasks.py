...
def task_player_docking(sim, task):
    #---------------------------------------------------------------------------------------
    for player_ship_id in query.role("basic_docking"):
        if sim.space_object_exists(player_ship_id):
            player = sim.get_space_object(player_ship_id)
            blob = query.get_engine_data_set(player_ship_id, sim)
            ...
            if sim.space_object_exists(dock_station_id):
                dock_station = sim.get_space_object(dock_station_id)
